  ...
  <div class="MeetingsList card-columns">
    <div class="Item item-metting card" :key="item.id" v-for="item in meetings">
      ...
      <div class="card-block">
        <div class="row">
          <span><strong>Team:</strong> {{ item.teamName }}</span>
        </div>
        <div class="row">
        ...
        <div v-if="item.factStart">
          <div class="row" >
            <span><strong>Actual Date and Time:</strong></span>
          </div>
        ...
        <div class="row">
            <span><strong>Facilitator:</strong> {{  getUser(item, item.facilitator) }}</span>
        </div>
        <div class="row">
            <span><strong>Secretary:</strong> {{  getUser(item, item.secretary) }}</span>
        </div>
